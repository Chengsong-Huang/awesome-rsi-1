...
- ![RSI][rsi-badge] - the system changes a persistent part of itself, evaluates the change, and applies the same or an improved process again.
- ![Self-improvement][self-improvement-badge] - the system persistently improves model weights, prompts, memory, tools, skills, or scaffolding, but the improvement operator itself remains fixed.
- ![Enabler][enabler-badge] - automated research, optimization, evaluation, or safety work that could support RSI but is not itself RSI.

Clickable resource badges identify primary artifacts: ![Paper][paper-badge] ![Code][code-badge] ![Dataset][dataset-badge] ![Project][project-badge] ![Collection][collection-badge]
...
| Generates, filters, or repairs data and trains a later model on it | Yes | ![Self-improvement][self-improvement-badge] if the data loop is system-driven |
| Stores experience that changes later behavior | Yes | ![Self-improvement][self-improvement-badge] when reuse is demonstrated; otherwise ![Enabler][enabler-badge] |
| Updates prompts, memory, tools, skills, routing, permissions, or executable control logic | Yes | ![Self-improvement][self-improvement-badge] |
| Improves the updater, evaluator, mutation policy, or harness engineer used in later rounds | Yes | ![RSI][rsi-badge] candidate |
| Optimizes an external artifact while the agent remains fixed | Yes, in an adjacent section | ![Enabler][enabler-badge] |
...
- ![RSI][rsi-badge] [Recursive Self-Improvement in AI: From Bounded Self-Refinement to Autonomous Research Loops](https://arxiv.org/abs/2607.07663) (2026) - Broad survey organizing self-improvement by what changes and who verifies the change.
- ![RSI][rsi-badge] [From Seed AI to Technological Singularity via Recursively Self-Improving Software](https://arxiv.org/abs/1502.06512) (2015) - Definitions, prior work, computational limits, and RSI convergence theory.
- ![RSI][rsi-badge] [Gödel Machines: Self-Referential Universal Problem Solvers Making Provably Optimal Self-Improvements](https://arxiv.org/abs/cs/0309048) (2003) - The classic formal architecture for provably useful self-rewrites.
- ![RSI][rsi-badge] [Gödel Agent](https://arxiv.org/abs/2410.04444) (ACL 2025) - A self-referential LLM agent that edits its own logic rather than following a fixed hand-authored optimizer. [![Code][code-badge]](https://github.com/Arvid-pku/Godel_Agent "Code")
...
- [Self-Improvements in Modern Agentic Systems: A Survey](https://arxiv.org/abs/2607.13104) (2026) - A 239-paper map separating foundation-model improvement from prompt, memory, tool, and full-scaffolding improvement. [![Living list][collection-badge]](https://github.com/selfimproving-agent/Awesome-Self-Improving-Agents "Living list")
...
- [A Survey on Self-Evolution of Large Language Models](https://arxiv.org/abs/2404.14387) (2024) - Frames model self-evolution as repeated experience acquisition, refinement, updating, and evaluation. [![Living list][collection-badge]](https://github.com/AlibabaResearch/DAMO-ConvAI/tree/main/Awesome-Self-Evolution-of-LLM "Living list")
...
- [A Systematic Survey of Self-Evolving Agents: From Model-Centric to Environment-Driven Co-Evolution](https://doi.org/10.36227/techrxiv.177203250.05832634/v2) (2026) - Extends the scope to agent–environment co-evolution. [![Collection][collection-badge]](https://github.com/XMUDeepLIT/Awesome-Self-Evolving-Agents "Collection")
- [The Path to Recursive Self-Improving Agents: Foundation, Framework, and Future Directions](https://www.preprints.org/manuscript/202608.0051) (2026) - Grades agent self-improvement from manual updates through general RSI and separates harness, data-system, trainer, and cross-component evolution. [![Living list][collection-badge]](https://github.com/D2I-ai/awesome-recursive-self-improving-agents "Living list")
...
- [Population Based Training of Neural Networks](https://arxiv.org/abs/1711.09846) (2017) - Jointly evolves parameters and hyperparameters during training. [![Overview][overview-badge]](https://deepmind.google/blog/population-based-training-of-neural-networks/ "Overview")
...
- [AutoML-Zero](https://arxiv.org/abs/2003.03384) (ICML 2020) - Evolves complete machine-learning algorithms from primitive operations. [![Code][code-badge]](https://github.com/google-research/google-research/tree/master/automl_zero "Code")
...
| ---: | --- | --- | --- |
| 2023 | [Self-Taught Optimizer (STOP)](https://arxiv.org/abs/2310.02304) · [![Code][code-badge]](https://github.com/microsoft/stop "Code") | ![RSI][rsi-badge] | An LLM improves a program that is itself used to improve code. |
| 2024 | [Automated Design of Agentic Systems (ADAS)](https://arxiv.org/abs/2408.08435) · [![Code][code-badge]](https://github.com/ShengranHu/ADAS "Code") | ![Self-improvement][self-improvement-badge] | A meta-agent searches over agent programs; the meta-optimizer stays fixed. |
| 2024 | [AFlow: Automating Agentic Workflow Generation](https://arxiv.org/abs/2410.10762) · [![Code][code-badge]](https://github.com/FoundationAgents/AFlow "Code") | ![Self-improvement][self-improvement-badge] | Agent workflows are generated and refined against task feedback. |
| 2025 | [Gödel Agent](https://arxiv.org/abs/2410.04444) · [![Code][code-badge]](https://github.com/Arvid-pku/Godel_Agent "Code") | ![RSI][rsi-badge] | The agent dynamically modifies its own task-solving and optimization logic. |
| 2025 | [A Self-Improving Coding Agent (SICA)](https://arxiv.org/abs/2504.15228) · [![Code][code-badge]](https://github.com/MaximeRobeyns/self_improving_coding_agent "Code") | ![RSI][rsi-badge] | A coding agent edits and evaluates its own implementation. |
| 2025 | [Darwin Gödel Machine](https://arxiv.org/abs/2505.22954) · [![Code][code-badge]](https://github.com/jennyzzt/dgm "Code") | ![RSI][rsi-badge] | An archive-based evolutionary loop modifies coding-agent code and reuses improved descendants. |
| 2026 | [Huxley-Gödel Machine](https://arxiv.org/abs/2510.21614) · [![Code][code-badge]](https://github.com/metauto-ai/HGM "Code") | ![RSI][rsi-badge] | An empirical approximation of a Gödel machine develops its own coding-agent implementation. |
| 2026 | [HyperAgents](https://arxiv.org/abs/2603.19461) · [![Code][code-badge]](https://github.com/facebookresearch/HyperAgents "Code") | ![RSI][rsi-badge] | Task and meta-agent roles are integrated so the agent can modify its own improver. |
| 2026 | [MOSS](https://arxiv.org/abs/2605.22794) · [![Code][code-badge]](https://github.com/hkgai-official/Moss "Code") | ![RSI][rsi-badge] | An agent rewrites its TypeScript source, replays failure batches, and promotes container images through an approval and rollback gate. |
| 2026 | [EvoTrainer](https://arxiv.org/abs/2606.03108) · [![Code][code-badge]](https://github.com/AlibabaResearch/DAMO-ConvAI/tree/main/EvoTrainer "Code") | ![RSI][rsi-badge] | Model policies and their training harnesses co-evolve under executable feedback. |
| 2026 | [SIA: Self Improving AI with Harness & Weight Updates](https://arxiv.org/abs/2605.27276) · [![Code][code-badge]](https://github.com/hexo-ai/sia "Code") | ![Self-improvement][self-improvement-badge] | A meta-agent updates both task harnesses and model weights under benchmark feedback. |
...
- ![Self-improvement][self-improvement-badge] [Large Language Models Can Self-Improve](https://arxiv.org/abs/2210.11610) (EMNLP 2023) - Iterative self-generated rationales improve reasoning without new human labels.
- ![Self-improvement][self-improvement-badge] [Self-Instruct](https://arxiv.org/abs/2212.10560) (ACL 2023) - Bootstraps instruction-following data from a model's own generations. [![Code][code-badge]](https://github.com/yizhongw/self-instruct "Code")
- ![Self-improvement][self-improvement-badge] [STaR: Self-Taught Reasoner](https://arxiv.org/abs/2203.14465) (NeurIPS 2022) - Alternates rationale generation and fine-tuning. [![Code][code-badge]](https://github.com/ezelikman/STaR "Code")
- ![Self-improvement][self-improvement-badge] [Self-Play Fine-Tuning (SPIN)](https://arxiv.org/abs/2401.01335) (ICML 2024) - Uses successive model checkpoints as players in a self-play objective. [![Code][code-badge]](https://github.com/uclaml/SPIN "Code")
- ![Self-improvement][self-improvement-badge] [Self-Rewarding Language Models](https://arxiv.org/abs/2401.10020) (2024) - The model generates both candidate responses and preference judgments for iterative training.
- ![Self-improvement][self-improvement-badge] [Reinforced Self-Training (ReST)](https://arxiv.org/abs/2308.08998) (2023) - Repeatedly generates a dataset with the current policy and improves that policy through reward-filtered offline training.
- ![Self-improvement][self-improvement-badge] [Meta-Rewarding Language Models](https://arxiv.org/abs/2407.19594) (2024) - Adds a meta-judge that critiques the model's own judgments so both task behavior and the evaluator improve across training rounds.
- ![Self-improvement][self-improvement-badge] [Quiet-STaR](https://arxiv.org/abs/2403.09629) (2024) - Trains models to generate useful internal rationales broadly across text. [![Code][code-badge]](https://github.com/ezelikman/quiet-star "Code")
- ![Self-improvement][self-improvement-badge] [Self-Adapting Language Models (SEAL)](https://arxiv.org/abs/2506.10943) (2025) - Generates its own update directives and training data for persistent adaptation. [![Code][code-badge]](https://github.com/Continual-Intelligence/SEAL "Code")
- ![Self-improvement][self-improvement-badge] [SELF: Self-Evolution with Language Feedback](https://arxiv.org/abs/2310.00533) (2024) - Converts model feedback into improved responses and parameter updates.
- ![Self-improvement][self-improvement-badge] [SELF-GUIDE](https://arxiv.org/abs/2407.12874) (COLM 2024) - Produces task-specific synthetic instruction data for fine-tuning. [![Code][code-badge]](https://github.com/zhaochenyang20/Prompt2Model-Self-Guide "Code")
- ![Self-improvement][self-improvement-badge] [DIVE](https://arxiv.org/abs/2501.00747) (2025) - Diversifies and filters self-generated reasoning data across iterative training rounds. [![Code][code-badge]](https://github.com/qinyiwei/DIVE "Code")
- ![Self-improvement][self-improvement-badge] [LADDER](https://arxiv.org/abs/2503.00735) (2025) - Recursively decomposes problems to generate training experience for later model updates.
- ![Self-improvement][self-improvement-badge] [Test-Time Reinforcement Learning](https://arxiv.org/abs/2504.16084) (NeurIPS 2025) - Derives pseudo-rewards from unlabeled test distributions for online parameter adaptation. [![Code][code-badge]](https://github.com/PRIME-RL/TTRL "Code")
- ![Self-improvement][self-improvement-badge] [Self-Evolving Curriculum for LLM Reasoning](https://arxiv.org/abs/2505.14970) (2025) - Evolves the task curriculum jointly with reasoning training. [![Code][code-badge]](https://github.com/ServiceNow/sec "Code")
- ![Self-improvement][self-improvement-badge] [Learning to Reason without External Rewards](https://arxiv.org/abs/2505.19590) (ICLR 2026) - Uses intrinsic confidence signals for self-training. [![Code][code-badge]](https://github.com/sunblaze-ucb/Intuitor "Code")
- ![Self-improvement][self-improvement-badge] [Absolute Zero](https://arxiv.org/abs/2505.03335) (2025) - A single model proposes code-grounded tasks at its learning frontier, solves them, and trains from executable rewards without external data. [![Code][code-badge]](https://github.com/LeapLabTHU/Absolute-Zero-Reasoner "Code")
- ![Self-improvement][self-improvement-badge] [R-Zero](https://arxiv.org/abs/2508.05004) (ICLR 2026) - Co-evolves challenger and solver models to generate a targeted reasoning curriculum from zero seed tasks or labels. [![Code][code-badge]](https://github.com/Chengsong-Huang/R-Zero "Code")
- ![Self-improvement][self-improvement-badge] [SAGE](https://arxiv.org/abs/2603.15255) (2026) - Multi-agent generation and selection of reasoning experience for model evolution.
...
- ![Self-improvement][self-improvement-badge] [EnvHarness: Awakening Static Worlds for Agent Learning](https://arxiv.org/abs/2608.19880) (ICML 2026) - Synthesizes programmable harness components around a static environment from the current policy's failure trajectories and retrains the policy on the reshaped environment, evaluated on held-out instances across four domains. [![Code][code-badge]](https://github.com/google-research/envharness "Code")
...
- ![Enabler][enabler-badge] [Reflexion](https://arxiv.org/abs/2303.11366) (NeurIPS 2023) - Stores verbal feedback in episodic memory to improve later attempts. [![Code][code-badge]](https://github.com/noahshinn/reflexion "Code")
- ![Enabler][enabler-badge] [Self-Refine](https://arxiv.org/abs/2303.17651) (NeurIPS 2023) - Iterative feedback and revision without parameter updates. [![Code][code-badge]](https://github.com/madaan/self-refine "Code")
- ![Self-improvement][self-improvement-badge] [Voyager](https://arxiv.org/abs/2305.16291) (2023) - Builds and reuses an executable skill library through environment interaction. [![Code][code-badge]](https://github.com/MineDojo/Voyager "Code")
- ![Self-improvement][self-improvement-badge] [Dynamic Cheatsheet](https://arxiv.org/abs/2504.07952) (2025) - Maintains a self-curated memory of transferable strategies and validated code across otherwise independent inference tasks. [![Code][code-badge]](https://github.com/suzgunmirac/dynamic-cheatsheet "Code")
- ![Self-improvement][self-improvement-badge] [ReasoningBank](https://arxiv.org/abs/2509.25140) (ICLR 2026) - Distills reusable strategies from self-judged successes and failures, retrieves them for later tasks, and writes new lessons back into persistent reasoning memory. [![Code][code-badge]](https://github.com/google-research/reasoning-bank "Code")
- ![Self-improvement][self-improvement-badge] [Optimization by PROmpting (OPRO)](https://arxiv.org/abs/2309.03409) (ICLR 2024) - Uses an LLM as an optimizer over natural-language prompts.
- ![Self-improvement][self-improvement-badge] [Promptbreeder](https://arxiv.org/abs/2309.16797) (2023) - Evolves task prompts together with mutation prompts, making it unusually close to meta-improvement.
- ![Self-improvement][self-improvement-badge] [Eureka](https://arxiv.org/abs/2310.12931) (ICLR 2024) - Evolves reward programs using environment feedback. [![Code][code-badge]](https://github.com/eureka-research/Eureka "Code")
- ![Self-improvement][self-improvement-badge] [TextGrad](https://arxiv.org/abs/2406.07496) (2024) - Optimizes compound AI systems through textual feedback. [![Code][code-badge]](https://github.com/zou-group/textgrad "Code")
- ![Self-improvement][self-improvement-badge] [GEPA](https://arxiv.org/abs/2507.19457) (2025) - Reflective, Pareto-based evolution of prompts and other textual components. [![Code][code-badge]](https://github.com/gepa-ai/gepa "Code")
- ![Self-improvement][self-improvement-badge] [SkillOpt](https://arxiv.org/abs/2605.23904) (2026) - Optimizes reusable natural-language skills through trajectory-driven edits and held-out validation gates. [![Code][code-badge]](https://github.com/microsoft/SkillOpt "Code")
- ![Self-improvement][self-improvement-badge] [SkillHone](https://arxiv.org/abs/2606.08671) (2026) - Evolves whole skill packages while retaining evaluation and promotion decisions as auditable Git artifacts. [![Code][code-badge]](https://github.com/Tencent/SkillHone "Code")
- ![RSI][rsi-badge] [Who Grades the Grader?](https://arxiv.org/abs/2607.12790) (2026) - Co-evolves an inspectable evaluation metric with an agent skill library, exposing criterion drift as part of the loop. [![Code][code-badge]](https://github.com/amazon-science/Self-Evolving-Agents-Double-Ratchet "Code")
- ![Self-improvement][self-improvement-badge] [SkillWeaver](https://arxiv.org/abs/2504.07079) (2025) - Discovers and hones reusable web-agent skills through environment exploration. [![Code][code-badge]](https://github.com/OSU-NLP-Group/SkillWeaver "Code")
- ![Self-improvement][self-improvement-badge] [Alita](https://arxiv.org/abs/2505.20286) (2025) - Builds reusable tools with minimal predefined scaffolding. [![Code][code-badge]](https://github.com/CharlesQ9/Alita "Code")
- ![Self-improvement][self-improvement-badge] [Agentic Context Engineering](https://arxiv.org/abs/2510.04618) (ICLR 2026) - Evolves context and reusable playbooks from execution feedback. [![Code][code-badge]](https://github.com/ace-agent/ace "Code")
- ![Self-improvement][self-improvement-badge] [MemRL](https://arxiv.org/abs/2601.03192) (2026) - Applies runtime reinforcement learning to episodic-memory selection. [![Code][code-badge]](https://github.com/MemTensor/MemRL "Code")
...
- ![Enabler][enabler-badge] [MLAgentBench](https://arxiv.org/abs/2310.03302) (ICML 2024) - Agents execute iterative ML experiments on research tasks. [![Code][code-badge]](https://github.com/snap-stanford/MLAgentBench "Code")
- ![Enabler][enabler-badge] [The AI Scientist](https://arxiv.org/abs/2408.06292) (2024) - End-to-end idea generation, experiments, writing, and review. [![Code][code-badge]](https://github.com/SakanaAI/AI-Scientist "Code")
- ![Enabler][enabler-badge] [AIDE](https://arxiv.org/abs/2502.13138) (2025) - Tree-search ML engineering agent for iterative experiment design. [![Code][code-badge]](https://github.com/WecoAI/aideml "Code")
- ![Enabler][enabler-badge] [AlphaEvolve](https://arxiv.org/abs/2506.13131) (2025) - Evolutionary coding agent for algorithmic and scientific discovery; it improves target programs, not itself.
...
- ![Enabler][enabler-badge] [SWE-Spot](https://arxiv.org/abs/2601.21649) (2026) - Converts a target repository into four kinds of interactive repository-centric experience and trains persistent 4B repo experts. It is model/data improvement, not demonstrated recursive improvement. [![Code][code-badge]](https://github.com/SWE-Spot/swespot "Code") · [![Models and data][models-data-badge]](https://huggingface.co/swespot "Models and data")
- ![Self-improvement][self-improvement-badge] [Live-SWE-agent](https://arxiv.org/abs/2511.13646) (2025) - A runtime coding agent that distills repository interaction into reusable knowledge while solving software issues. [![Code][code-badge]](https://github.com/OpenAutoCoder/live-swe-agent "Code")
- ![Self-improvement][self-improvement-badge] [Agent-RLVR](https://arxiv.org/abs/2506.11425) (2025) - Trains software-engineering agents with guidance and executable environment rewards.
- ![Self-improvement][self-improvement-badge] [Socratic-SWE](https://arxiv.org/abs/2606.07412) (2026) - Derives reusable coding-agent skills from execution traces.
- ![Self-improvement][self-improvement-badge] [CODESKILL](https://arxiv.org/abs/2605.25430) (2026) - Learns and updates self-evolving skills specialized for coding agents.
...
- [SEAGym](https://arxiv.org/abs/2606.17546) (2026) - Converts Harbor-compatible tasks into train, frozen validation, held-out in- and out-of-distribution, replay, and cost views for evaluating harness updates. [![Code][code-badge]](https://github.com/antropy-research/SEAGym "Code")
...
- [SE-Bench](https://arxiv.org/abs/2602.04811) (2026) - Measures whether an agent internalizes new API knowledge and later applies it without documentation access. [![Code][code-badge]](https://github.com/thunlp/SE-Bench "Code")
- [LifelongAgentBench](https://arxiv.org/abs/2505.11942) (2025) - Tests experience accumulation and transfer through interdependent database, operating-system, and knowledge-graph tasks. [![Code][code-badge]](https://github.com/caixd-220529/LifelongAgentBench "Code")
- [StuLife](https://arxiv.org/abs/2508.19005) (2025) - A persistent virtual-campus environment for evaluating long-term memory, reusable skills, adaptation, and self-directed behavior across an academic-year task stream. [![Code][code-badge]](https://github.com/ECNU-ICALK/ELL-StuLife "Code")
...
- [ResearchGym](https://arxiv.org/abs/2602.15112) - End-to-end AI research tasks with solution methods withheld, fixed budgets, executable experiments, and human baselines. [![Code][code-badge]](https://github.com/Anikethh/ResearchGym "Code")
- [MLGym-Bench](https://arxiv.org/abs/2502.14499) - Open-ended machine-learning research tasks spanning hypothesis generation, implementation, training, and experimental iteration. [![Code][code-badge]](https://github.com/facebookresearch/MLGym "Code")
- [AIRS-Bench](https://arxiv.org/abs/2602.06855) - Twenty open-ended tasks from recent ML papers spanning idea generation, experiment analysis, and iterative refinement without starter code. [![Code][code-badge]](https://github.com/facebookresearch/airs-bench "Code")
- [PostTrainBench](https://arxiv.org/abs/2603.08640) - Gives agents one base model, one H100 GPU, and ten hours to research and execute an autonomous post-training strategy while auditing reward-hacking failures. [![Code][code-badge]](https://github.com/aisa-group/PostTrainBench "Code")
- [CORE-Bench](https://arxiv.org/abs/2409.11363) - Reproduction of computational research across multiple disciplines. [![Code][code-badge]](https://github.com/siegelz/core-bench "Code")
- [PaperBench](https://openai.com/index/paperbench/) - Replication of 20 ICML papers, decomposed into 8,316 gradable tasks. [![Code][code-badge]](https://github.com/openai/preparedness/tree/main/project/paperbench "Code")
- [Meta-Agent Challenge](https://arxiv.org/abs/2606.04455) - Meta-agents build complete agents inside a sealed environment; a verifier scores the result on a hidden test set. [![Code][code-badge]](https://github.com/ant-research/meta-agent-challenge "Code")
- [Frontier-Eng](https://arxiv.org/abs/2604.12290) - Tracks improvement trajectories on 47 generative engineering-optimization tasks with frozen verifiers. [![Code][code-badge]](https://github.com/EinsiaLab/Frontier-Engineering "Code")
- ![Enabler][enabler-badge] [Φ-Bench: Can Large Language Models Engineer the Infrastructure That Powers Them?](https://faibench.org/) (2026) - A StepFun- and USTC-led benchmark with 85 Docker-reproducible LLM-infrastructure engineering tasks spanning kernel function completion, long-horizon repository implementation, and end-to-end system optimization. It supplies executable infrastructure tasks and offline graders for RSI research, but does not itself measure persistent or recursive self-change. [![Code and paper][code-paper-badge]](https://github.com/one2piece2hello/faibench_Frontier_InfraBench "Code and paper") · [![Dataset][dataset-badge]](https://huggingface.co/datasets/faibench-Frontier-Infra-Bench/faibench_Frontier_Infra_Bench "Dataset")
...
- [SWE-bench](https://arxiv.org/abs/2310.06770) - Real-world GitHub issue resolution. [![Code][code-badge]](https://github.com/SWE-bench/SWE-bench "Code")
...
- ![Self-improvement][self-improvement-badge] [SHE: Trajectory-driven Safety Harness Evolution for LLM Agents](https://arxiv.org/abs/2608.09885) (2026) - Attributes rollout failures to the System Prompt, Rule Bank, Safety Memory, or Tool Policy, then retains bounded edits through safety–utility validation. It reduces attack success versus a static harness and transfers to held-out risks and agent models. [![Code][code-badge]](https://github.com/RainbowQTT/SHE "Code")
- ![Self-improvement][self-improvement-badge] [Self-Harness](https://arxiv.org/abs/2606.09498) (2026) - Mines model-specific weaknesses, proposes minimal executable harness changes, and accepts them only after regression testing on Terminal-Bench, SWE-bench Verified, and AppWorld.
- ![RSI][rsi-badge] [Who Grades the Grader?](https://arxiv.org/abs/2607.12790) (2026) - Co-evolves an agent skill library and its inspectable metric, making evaluator drift part of the state under study. [![Code][code-badge]](https://github.com/amazon-science/Self-Evolving-Agents-Double-Ratchet "Code")
...
- [Your Agent May Misevolve](https://arxiv.org/abs/2509.26354) (ICLR 2026) - Measures harmful drift across model, memory, tool, and workflow evolution, including degraded safety alignment and vulnerabilities introduced by accumulated updates. [![Code and data][code-data-badge]](https://github.com/ShaoShuai0605/Misevolution "Code and data")
...
- [Large Language Model Agents Are Not Always Faithful Self-Evolvers](https://arxiv.org/abs/2601.22436) (ICML 2026) - Studies whether retained updates actually reflect the experience claimed to cause them. [![Code][code-badge]](https://github.com/Dreamcatcher0622/Faithfulness "Code")
...
| [SICA](https://github.com/MaximeRobeyns/self_improving_coding_agent) | Its own coding-agent codebase | Benchmark + keep/revert | [![Paper][paper-badge]](https://arxiv.org/abs/2504.15228 "Paper") |
| [Gödel Agent](https://github.com/Arvid-pku/Godel_Agent) | Agent logic and self-improvement procedure | Task evaluation | [![Paper][paper-badge]](https://arxiv.org/abs/2410.04444 "Paper") |
| [Huxley-Gödel Machine](https://github.com/metauto-ai/HGM) | Coding-agent implementation | Benchmark + evolutionary selection | [![Paper][paper-badge]](https://arxiv.org/abs/2510.21614 "Paper") |
| [HyperAgents](https://github.com/facebookresearch/HyperAgents) | Task agent and meta-agent logic | Task evaluation | [![Paper][paper-badge]](https://arxiv.org/abs/2603.19461 "Paper") |
| [MOSS](https://github.com/hkgai-official/Moss) | TypeScript source and container image | Replay + approval + rollback | [![Paper][paper-badge]](https://arxiv.org/abs/2605.22794 "Paper") |
...
| [Adaptive Auto-Harness](https://github.com/A-EVO-Lab/AdaptiveHarness) | Stateful harness tree and solve-time router | Open-ended stream evaluation + routing | [![Paper][paper-badge]](https://arxiv.org/abs/2606.01770 "Paper") |
| [Continual Harness](https://github.com/sethkarten/continual-harness) | Prompt, subagents, skills, and memory in one continuous episode | Online task progress; reset-free updates | [![Paper][paper-badge]](https://arxiv.org/abs/2605.09998 "Paper") |
| [Harness-R1](https://github.com/DeepExperience/Harness-R1) | Executable runtime patches and a learned harness engineer | Frozen-target reruns + RL outcome reward | [![Paper][paper-badge]](https://arxiv.org/abs/2608.02276 "Paper") |
...
| [Harness Evolver](https://github.com/raphaelchristi/harness-evolver) | Prompts, routing, retrieval, tools, orchestration | Held-out eval + constraints + rollback | [![Paper][paper-badge]](https://arxiv.org/abs/2603.28052 "Paper") |
...
| [GEA](https://github.com/UCSB-AI/GEA) | Agent variants and shared experience | Benchmark selection | [![Paper][paper-badge]](https://arxiv.org/abs/2602.04837 "Paper") |
| [Yunjue Agent](https://github.com/YunjueTech/Yunjue-Agent) | Executable tools and their versions | Binary execution feedback | [![Paper][paper-badge]](https://arxiv.org/abs/2601.18226 "Paper") |
| [CORAL](https://github.com/Human-Agent-Society/CORAL) | Agent organizations, shared skills, attempts, and policies | Grader-scored commits | [![Paper][paper-badge]](https://arxiv.org/abs/2604.01658 "Paper") |
| [OpenRSI / OpenMLE](https://github.com/FrontisAI/OpenRSI) | Executable tasks, SFT/RL operators, programs, model weights, and evolutionary search | Execution feedback + held-out transfer evaluation | [![Paper][paper-badge]](https://arxiv.org/abs/2607.28568 "Paper") |
...
| Project | Persistent surface | Gate | Evidence |
| --- | --- | --- | --- |
| [SkillOpt](https://github.com/microsoft/SkillOpt) | Natural-language skills | Held-out validation + promotion | [![Paper][paper-badge]](https://arxiv.org/abs/2605.23904 "Paper") |
| [SkillHone](https://github.com/Tencent/SkillHone) | Whole skill packages | Evaluation + Git-native decisions | [![Paper][paper-badge]](https://arxiv.org/abs/2606.08671 "Paper") |
| [EvoSkill](https://github.com/sentient-agi/EvoSkill) | Skills and prompts synthesized from failures | Held-out evaluation | [![Paper][paper-badge]](https://arxiv.org/abs/2603.02766 "Paper") |
...
| [Evolver](https://github.com/EvoMap/evolver) | Genes, reusable capsules, and personality | Versioned events + rollback | [![Paper][paper-badge]](https://arxiv.org/abs/2604.15097 "Paper") |
...
| [Voyager](https://github.com/MineDojo/Voyager) | Executable skill library | Environment feedback | [![Paper][paper-badge]](https://arxiv.org/abs/2305.16291 "Paper") |
| [SEAL](https://github.com/Continual-Intelligence/SEAL) | Model weights through generated update data | Reward-guided training | [![Paper][paper-badge]](https://arxiv.org/abs/2506.10943 "Paper") |
| [RewardHarness](https://github.com/TIGER-AI-Lab/RewardHarness) | Reward tools and skills | Preference accuracy + downstream RL | [![Paper][paper-badge]](https://arxiv.org/abs/2605.08703 "Paper") |
| [SkillWeaver](https://github.com/OSU-NLP-Group/SkillWeaver) | Web-agent skill library | Environment execution feedback | [![Paper][paper-badge]](https://arxiv.org/abs/2504.07079 "Paper") |
| [CoEvoSkills](https://github.com/Zhang-Henry/CoEvoSkills) | Skills and their verification process | Co-evolutionary verification | [![Paper][paper-badge]](https://arxiv.org/abs/2604.01687 "Paper") |
| [Skill Self-Play](https://github.com/Qwen-Applications/skill-self-play) | Skills and task challenges | Co-evolving self-play evaluation | [![Paper][paper-badge]](https://arxiv.org/abs/2607.22529 "Paper") |
| [OpenSkill](https://github.com/OpenLAIR/OpenSkill) | Skills and self-created verification signals | Open-world verification | [![Paper][paper-badge]](https://arxiv.org/abs/2606.06741 "Paper") |
| [ACE](https://github.com/ace-agent/ace) | Context and reusable playbooks | Execution feedback + context evolution | [![Paper][paper-badge]](https://arxiv.org/abs/2510.04618 "Paper") |
...
| [NanoResearch](https://github.com/OpenRaiser/NanoResearch) | Research policy, skills, and memory | Co-evolution loop; [![Paper][paper-badge]](https://arxiv.org/abs/2605.10813 "Paper") |
...
[rsi-badge]: https://img.shields.io/badge/RSI-6D28D9?style=flat-square
[self-improvement-badge]: https://img.shields.io/badge/Self--improvement-2563EB?style=flat-square
[enabler-badge]: https://img.shields.io/badge/Enabler-64748B?style=flat-square
[code-badge]: https://img.shields.io/badge/Code-181717?style=flat-square&logo=github&logoColor=white
[paper-badge]: https://img.shields.io/badge/Paper-B31B1B?style=flat-square&logo=arxiv&logoColor=white
[dataset-badge]: https://img.shields.io/badge/Dataset-FFD21E?style=flat-square&logo=huggingface&logoColor=111827
[project-badge]: https://img.shields.io/badge/Project-0EA5E9?style=flat-square&logo=googlechrome&logoColor=white
[collection-badge]: https://img.shields.io/badge/Collection-059669?style=flat-square&logo=awesomelists&logoColor=white
[overview-badge]: https://img.shields.io/badge/Overview-7C3AED?style=flat-square&logo=bookstack&logoColor=white
[code-paper-badge]: https://img.shields.io/badge/Code%20%2B%20Paper-181717?style=flat-square&logo=github&logoColor=white
[code-data-badge]: https://img.shields.io/badge/Code%20%2B%20Data-181717?style=flat-square&logo=github&logoColor=white
[models-data-badge]: https://img.shields.io/badge/Models%20%2B%20Data-FFD21E?style=flat-square&logo=huggingface&logoColor=111827
